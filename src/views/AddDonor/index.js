          ...
          <Box mt={2}>
            ...
            {tabIndex === 1 && (
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={4}>
                  <TextField fullWidth label="Mobile No."  size='small' name="contactPurpose" value={caseData.contactPurpose} onChange={handleChange} />
                </Grid>
                <Grid item xs={12} sm={4}>
                  <TextField fullWidth label="Email"  size='small' name="contactPurpose" value={caseData.contactPurpose} onChange={handleChange} />
                </Grid>

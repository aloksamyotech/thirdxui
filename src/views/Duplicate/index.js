...
const Duplicate = () => {
    ...
    const rows = [
        { id: 1, userid: 'D-123', name: 'Snow', email: 'bob@gmail.com', dob: '27-03-04', age: '20', country: 'India', gender: 'Male', ethicity: 'Black', no: '1234561234' },
    ];
    const columns = [
        {
            field: 'name',
            ...
            renderCell: (params) =>
                <Grid container sx={{ ml: '10px' }}>
                    ...
                    <Grid item xs={9} >
                        <Grid container>
                            <Grid item xs={7.5}>
                                <Typography color='primary' sx={{ display: 'inline', paddingX: '12px', marginLeft: '-13px', cursor: 'pointer', '&:hover': { textDecoration: 'underline' } }}>{params?.row?.name}</Typography>
                            </Grid>
                            <Grid item xs={12}>
        ...
        <Box sx={{ width: '100%', typography: 'body1', bgcolor: '#fff', borderRadius: '10px', minHeight: '100vh' }}>
            ...
            <Box height='200px' width='100%'>
                ...
                <Stack direction='row' sx={{ display: 'flex', justifyContent: 'flex-end', m: '10px' }}>
                    <Button size='small' variant="outlined" startIcon={<CallMergeIcon />} sx={{ marginRight: '10px', color: '#fdc250', border: '1px solid #fdc250' }}>
                        Merge
                    </Button>
                    <Button size='small' variant="outlined" startIcon={<DeleteIcon />} sx={{ marginRight: '10px', color: '#ff918d', border: '1px solid #ff918d' }}>
                        Delete
                    </Button>
                </Stack>
            </Box>

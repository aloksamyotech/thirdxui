  ...
  return (<>
    <Box sx={{ width: '100%', typography: 'body1', bgcolor: '#fff', borderRadius: '10px', minHeight: '100vh' }}>
      <TabContext value={value}>
        ...
        <TabPanel value="1" sx={{ p: 0 }}><Service /></TabPanel>
        <TabPanel value="2" sx={{ p: 0 }}><Cases /></TabPanel>
        <TabPanel value="3" sx={{ p: 0 }}><Session /></TabPanel>
        <TabPanel value="4" sx={{ p: 0 }}><Survey /></TabPanel>
      </TabContext>
    </Box>
  </>
  )
